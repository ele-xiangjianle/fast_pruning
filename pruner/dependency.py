...
import typing
import pruner.structured as structured
...
class DependencyGraph(object):
    ...
    HANDLER = {    # pruning function that changes 1. in_channel           2. out_channel
                OPTYPE.CONV                 :  (structured.prune_related_conv,   structured.prune_conv),
                OPTYPE.BN                   :  (structured.prune_batchnorm,      structured.prune_batchnorm),
                OPTYPE.PRELU                :  (structured.prune_prelu,          structured.prune_prelu),
                OPTYPE.LINEAR               :  (structured.prune_related_linear, structured.prune_linear),
                OPTYPE.GROUP_CONV           :  (structured.prune_group_conv,     structured.prune_group_conv),
                ...
                OPTYPE.LN                   :  (structured.prune_layernorm,      structured.prune_layernorm),
                OPTYPE.EMBED                :  (structured.prune_embedding,      structured.prune_embedding),
    ...
    def register_customized_layer(self, layer_type, in_ch_pruning_fn, out_ch_pruning_fn, get_in_ch_fn, get_out_ch_fn):
        ...
        Parameters:
            ...
            in_ch_pruning_fn (Callable): A function to structured channels/dimensions of input tensor
            out_ch_pruning_fn (Callable): A function to structured channels/dimensions of output tensor
    ...
    def get_pruning_plan(self, module: nn.Module, pruning_fn: typing.Callable, idxs: typing.Union[list, tuple]): 
        ...
        if isinstance(module, TORCH_CONV) and module.groups>1:
            pruning_fn = structured.prune_group_conv
